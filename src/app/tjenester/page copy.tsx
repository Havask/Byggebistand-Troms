...
const SubCollapsible = ({ title, icon: Icon, content, id, isOpen, onToggle }: SubCollapsibleProps) => {
  ...
  return (
    <div className="border-b border-[#205e37]/20 last:border-b-0">
      <button
        onClick={() => {
          console.log(`SubCollapsible button clicked: ${id}`);
          onToggle();
        }}
        className="w-full flex items-center justify-between py-4 px-6 text-left bg-[#dde6df] hover:bg-[#c8d8ce] dark:bg-[#dde6df] dark:hover:bg-[#c8d8ce] transition-colors duration-200 rounded-xl shadow-md"
      >
        <div className="flex items-center gap-4">
          <Icon className="w-6 h-6 text-[#205e37] dark:text-[#205e37]" />
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 tracking-tight">{title}</h3>
        </div>
        <ChevronDownIcon
          className={`w-5 h-5 text-[#205e37] dark:text-[#205e37] transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
      <div
        className={`overflow-hidden transition-all duration-200 ease-in-out ${isOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div className="px-6 py-5 text-gray-600 dark:text-gray-600 leading-relaxed bg-white/50 dark:bg-white/50 rounded-b-xl">{content}</div>
      </div>
    </div>
  );
};
...
const CollapsibleSection = ({ title, icon: Icon, content, id, isOpen, onToggle }: CollapsibleSectionProps) => {
  ...
  return (
    <div
      id={id}
      className="bg-[#dde6df] dark:bg-[#dde6df] rounded-3xl shadow-xl border border-[#205e37]/30 dark:border-[#205e37]/30 overflow-hidden"
    >
      <button
        onClick={() => {
        ...
        className="w-full flex items-center justify-between p-6 text-left bg-[#dde6df] hover:bg-[#c8d8ce] dark:bg-[#dde6df] dark:hover:bg-[#c8d8ce] transition-colors duration-200"
      >
        <div className="flex items-center gap-5">
          <div className="p-4 bg-gradient-to-br from-[#205e37] to-[#8db8a0] rounded-full shadow-lg">
            <Icon className="w-7 h-7 text-white" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-900 tracking-tighter">
            {title}
          </h2>
        </div>
        <ChevronDownIcon
          className={`w-6 h-6 text-[#205e37] dark:text-[#205e37] transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`}
        />
      </button>
      <div
        className={`overflow-hidden transition-all duration-200 ease-in-out ${isOpen ? "max-h-[2000px] opacity-100" : "max-h-0 opacity-0"}`}
      >
        <div className="p-6 text-gray-600 dark:text-gray-600 leading-relaxed bg-white/60 dark:bg-white/60">{content}</div>
      </div>
    </div>
  );
};
...
export default function Tjenester() {
  ...
  const sectionLinks = [
    {
      ...
      content: (
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-900 mb-3">
              ...
              content={
                <div>
                  ...
                  <p className="mt-4">
                    ...
                    <a href="https://naturskade.no" className="text-[#205e37] underline hover:text-[#8db8a0] transition-colors duration-200">
                      naturskade.no
                    </a>.
                  </p>
                </div>
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] font-sans overflow-x-hidden">
      {/* Hero Section - 50/50 Split Banner */}
      <section className="relative bg-[#dde6df] text-[#205e37] h-[70vh] min-h-[500px]">

        <div className="relative z-10 h-full flex">
          {/* Text content - left half */}
          <div className="w-1/2 h-full flex items-center justify-center">
            <Container className="max-w-md px-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 font-arial">
                Våre tjenester
              </h1>
              <p className="text-lg md:text-xl text-[#205e37]/90">
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gradient-to-br from-[#205e37] to-[#8db8a0] text-white relative overflow-hidden">
        <Container className="text-center relative z-10">
          ...
          <div className="mt-8">
            <Link
              ...
              className="inline-flex items-center px-16 py-6 bg-[#205e37] text-white rounded-full font-semibold text-2xl hover:bg-[#8db8a0] transition-colors duration-200 shadow-2xl"
            >
